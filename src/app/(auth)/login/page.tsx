...
export default function LoginPage() {
  ...
  const handleEmailLogin = async () => {
    ...
    if (res?.error) {
      // next-auth error message raw aata hai, clean karo
    ...
    // redirect useEffect handle karega session update hone pe
    toast.success("Welcome back!");
  };

  // session load hone tak kuch mat dikhao
  if (status === "loading") return null;

  // already logged in hai to kuch mat dikhao (useEffect redirect karega)
